...
if __name__ == "__main__":
    ...
    ytrain = train_df.SalePrice.values
    yvalid = valid_df.SalePrice.values

    train_df = train_df.drop(["Id", "SalePrice", "kfold"], axis=1)
    valid_df = valid_df.drop(["Id", "SalePrice", "kfold"], axis=1)
